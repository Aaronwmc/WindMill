...
<head>
	...
	<link href="css/pureweber.css" rel="stylesheet">
...
<form id="upload-form" action="index.php?r=uploadT/upload" method="POST" enctype="multipart/form-data" style="margin:15px 0" target="hidden_iframe">
